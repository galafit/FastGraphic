...
public class FastFrame extends JFrame implements Runnable {
    ...
    public void run() {
        ...
        while (running) {
            ...
            // на тестовой машине этот пример со sleep() дает около  fps (загрузка CPU 1-2%),

            // с yield() - 0 fps (загрузка CPU %)
...
//              FastFrame.create("Fast Updates", 0, 4, true); // полноэкранный режим
